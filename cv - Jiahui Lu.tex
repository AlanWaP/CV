...
\documentclass[11pt, a4paper]{styles/awesome-cv} % A4 paper size by default, use 'letterpaper' for US letter
...
\mobile{(+1) 404-429-2362}

%\email{jlu355@gatech.edu}
\email{lujiahui1@hotmail.com}
\homepage{alanwap.github.io}
\github{AlanWaP}
\linkedin{AlanWaP}
%\skype{skypeid}
...
%\makecvfooter{\today}{Jiahui Lu}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
\makecvfooter{}{Jiahui Lu}{\thepage}
